...
export const MagicLinkEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your private access link — The Perfume Lab</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Heading style={h1}>Your private access link</Heading>
        <Text style={text}>
          Use the button below to enter {siteName}. This link expires shortly — treat it as your personal key.
        </Text>
