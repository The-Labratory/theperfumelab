...
import {
  Share2, Crown, Trophy, Flame, Eye, Copy, Check,
...
/* ── Fake weekly leaderboard — social proof ── */
const weeklyLeaders = [
  { name: "Anon #0042", harmony: 97, city: "Dubai", blends: 6 },
  { name: "Anon #0017", harmony: 96, city: "Paris", blends: 4 },
  { name: "Anon #0003", harmony: 94, city: "Tokyo", blends: 8 },
  { name: "Anon #0058", harmony: 91, city: "London", blends: 3 },
  { name: "Anon #0024", harmony: 89, city: "Milan", blends: 5 },
];
...
const statusTriggers = [
  ...
  "Blend No. 0042 has been shared 147 times.",
  "A new Grand Perfumer was crowned today.",
  "The weekly leaderboard resets in 4 days.",
...
const SharePage = () => {
  ...
  return (
    <div className="min-h-screen bg-background overflow-hidden">
      ...
      {/* ── BLEND SELECTOR — if multiple blends ── */}
      {blends.length > 1 && (
        <section className="relative z-10 py-4 px-4 sm:px-6">
          <div className="max-w-lg mx-auto">
            <p className="text-[9px] font-display tracking-[0.3em] text-muted-foreground/60 text-center mb-3">
              YOUR COMPOSITIONS
            </p>
      ...
      {blends.length === 0 && (
        <section className="relative z-10 py-12 px-4 sm:px-6">
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="max-w-sm mx-auto glass-surface rounded-2xl p-8 text-center border border-primary/20"
          >
            ...
            <p className="text-xs text-muted-foreground font-body mb-6 leading-relaxed">
              Create your first blend in the Scent Lab to unlock your Identity Card
              and enter the arena.
            </p>
            <Link
              to="/lab"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-primary text-primary-foreground font-display text-xs tracking-widest glow-primary"
            >
      ...
      {/* ── WEEKLY LEADERBOARD — competition drives obsession ── */}
        ...
        >
          <div className="text-center mb-6">
            ...
            <p className="text-[10px] text-muted-foreground font-body">
              Resets every Monday. Can you reach the top?
            </p>
          </div>

          <div className="space-y-2">
            {weeklyLeaders.map((leader, i) => {
              const rank = getRank(leader.harmony);
              return (
                <motion.div
                  key={leader.name}
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-[9px] text-muted-foreground/60 font-body">
                      {leader.city} · {leader.blends} blends
                    </div>
                  </div>
          ...
          >
            <p className="text-[10px] font-display tracking-widest text-muted-foreground">
              YOUR RANK: <span className="text-accent">UNRANKED</span>
            </p>
            <p className="text-[9px] text-muted-foreground/50 font-body mt-1">
              Create a blend with 85%+ harmony to enter the leaderboard
            </p>
          </motion.div>
        </motion.div>
      </section>

      {/* ── SHARE TOOLKIT — frictionless viral spread ── */}
      <section className="relative z-10 py-16 px-4 sm:px-6">
        <motion.div
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
        ...
        >
          ...
          <p className="text-[10px] text-muted-foreground font-body mb-5">
            The fewer people who know, the more exclusive your rank stays.
          </p>
      ...
      {/* ── PSYCHOLOGY HOOKS — addiction loops ── */}
      <section className="relative z-10 py-16 px-4 sm:px-6 border-t border-border/20">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-[10px] text-muted-foreground font-body">
              Every week, the game resets. Every blend, your rank evolves.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              >
                ...
                <div className="text-[8px] font-display tracking-[0.2em] text-muted-foreground mb-1">
                  {hook.label}
                </div>
                <p className="text-[9px] text-muted-foreground/60 font-body leading-relaxed">
                  {hook.desc}
                </p>
              </motion.div>
            ))}
      ...
      <section className="relative z-10 py-16 px-4 sm:px-6 border-t border-border/30">
        ...
        >
          ...
          <p className="text-[10px] text-muted-foreground/60 font-body mb-6">
            The leaderboard is waiting. The question is — are you?
          </p>
          <Link
            to="/lab"
            className="inline-flex items-center gap-2 px-8 py-3.5 rounded-xl bg-primary text-primary-foreground font-display text-sm tracking-widest glow-primary hover:brightness-110 transition-all"
          >
...
/* ── IDENTITY CARD COMPONENT — the shareable artifact ── */
  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-6">
        ...
        {blend.name && (
          <div className="font-body text-xs text-muted-foreground mt-2 italic">"{blend.name}"</div>
        )}
      </div>
