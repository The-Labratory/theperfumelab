...
const TIERS = [
  {
    ...
    code: "b2c",
    commission: 50,
    requirement: "Direct consumer sales",
    minSales: 0,
    color: "hsl(var(--primary))",
    bgClass: "bg-primary/20 border-primary/40",
    textClass: "text-primary",
    glowClass: "shadow-[0_0_30px_hsl(var(--primary)/0.3)]",
    width: "w-[50%]",
    emoji: "🔥",
  ...
  },
  {
    ...
    code: "b2b",
    commission: 20,
    requirement: "Business / wholesale reorders",
    minSales: 0,
    color: "hsl(var(--accent))",
    bgClass: "bg-accent/20 border-accent/40",
    textClass: "text-accent",
    glowClass: "shadow-[0_0_25px_hsl(var(--accent)/0.25)]",
    width: "w-full",
    emoji: "🏢",
